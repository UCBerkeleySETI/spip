...
class UWBContinuumDaemon (UWBProcDaemon):
  ...
  def prepare (self):
    ...
    try:
      continuum = (header["PERFORM_CONTINUUM"] == "1")
    ...
    self.out_dir = self.cfg["CLIENT_CONTINUUM_DIR"] + "/processing/" + beam + "/" + utc_start + "/" + source + "/" + self.cfreq
...
if __name__ == "__main__":
  ...
  print "main: script = UWBContinuumDaemon()"
