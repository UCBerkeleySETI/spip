...
spip::UDPFormatMeerKATSPEAD2k::UDPFormatMeerKATSPEAD2k()
{
...
void spip::UDPFormatMeerKATSPEAD2k::configure(const spip::AsciiHeader& config, const char* suffix)
{
...
void spip::UDPFormatMeerKATSPEAD2k::prepare (spip::AsciiHeader& header, const char * suffix)
{
...
#ifdef _DEBUG
  cerr << "spip::UDPFormatMeerKATSPEAD2k::prepare nstream=" << nstream 
...
void spip::UDPFormatMeerKATSPEAD2k::conclude ()
{
}


void spip::UDPFormatMeerKATSPEAD2k::generate_signal ()
{
}

uint64_t spip::UDPFormatMeerKATSPEAD2k::get_samples_for_bytes (uint64_t nbytes)
{
#ifdef _DEBUG
  cerr << "spip::UDPFormatMeerKATSPEAD2k::get_samples_for_bytes npol=" << npol 
...
uint64_t spip::UDPFormatMeerKATSPEAD2k::get_resolution ()
{
  return heap_size * nstream;
}

void spip::UDPFormatMeerKATSPEAD2k::set_channel_range (unsigned start, unsigned end) 
{
  cerr << "spip::UDPFormatMeerKATSPEAD2k::set_channel_range start=" << start 
       << " end=" << end << endl;
  start_channel = start;
  end_channel   = end;
  nchan = (end - start) + 1;
  cerr << "spip::UDPFormatMeerKATSPEAD2k::set_channel_range nchan=" <<  nchan << endl;
}

inline void spip::UDPFormatMeerKATSPEAD2k::encode_header_seq (char * buf, uint64_t seq)
{
  encode_header (buf);
}

inline void spip::UDPFormatMeerKATSPEAD2k::encode_header (char * buf)
{
  //memcpy (buf, (void *) &header, sizeof (meerkat_spead_udp_hdr_t));
}


inline std::size_t spip::UDPFormatMeerKATSPEAD2k::decode_cbf_packet (spip::cbf_packet_header &out, const uint8_t *data, std::size_t max_size)
{
...
inline int64_t spip::UDPFormatMeerKATSPEAD2k::decode_packet (char* buf, unsigned * pkt_size)
{
  decode_cbf_packet (cbf_header, (const uint8_t *) buf, 2112);
...
inline int64_t spip::UDPFormatMeerKATSPEAD2k::get_subband (int64_t byte_offset, int nsubband)
{
...
inline int spip::UDPFormatMeerKATSPEAD2k::insert_last_packet (char * buffer)
{
...
inline void spip::UDPFormatMeerKATSPEAD2k::gen_packet (char * buf, size_t bufsz)
{
...
bool spip::UDPFormatMeerKATSPEAD2k::check_stream_stop ()
{
...
void spip::UDPFormatMeerKATSPEAD2k::print_packet_header()
{
