...
#ifndef __ExampleReadWriteBlockClient_h
#define __ExampleReadWriteBlockClient_h
...
namespace spip {
  ...
  class ExampleReadWriteBlockClient : public ReadWriteBlockClient {

    public:

      ExampleReadWriteBlockClient (const char * read_key_string,
                          const char * write_key_string);

      ~ExampleReadWriteBlockClient ();
