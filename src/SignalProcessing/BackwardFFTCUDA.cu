...
__global__ void backwardfftcuda_normalize_kernel (float * data, uint64_t nval, float scale)
{
...
void spip::BackwardFFTCUDA::normalize_output ()
{
  ...
  backwardfftcuda_normalize_kernel<<<nblock, nthread, 0, stream>>> (out, nval, scale_fac);
